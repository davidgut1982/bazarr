...
api_ns_episodes_blacklist = Namespace(
    "Episodes Blacklist",
...
class EpisodesBlacklist(Resource):
    ...
    get_language_model = api_ns_episodes_blacklist.model(
        "subtitles_language_model", subtitles_language_model
    )

    get_response_model = api_ns_episodes_blacklist.model(
        "EpisodeBlacklistGetResponse",
        {
    ...
    def get(self):
        ...
        stmt = (
            ...
            .join(
                TableShows,
                onclause=TableBlacklist.sonarr_series_id == TableShows.sonarrSeriesId,
            )
            .join(
                TableEpisodes,
                onclause=TableBlacklist.sonarr_episode_id
    ...
    post_request_parser.add_argument(
        "subs_id", type=str, required=True, help="Subtitles ID"
    )
    post_request_parser.add_argument(
        "language", type=str, required=True, help="Subtitles language"
    )
    post_request_parser.add_argument(
        "subtitles_path", type=str, required=True, help="Subtitles file path"
    )
    ...
    @api_ns_episodes_blacklist.response(
    ...
    delete_request_parser.add_argument(
        "all", type=str, required=False, help="Empty episodes subtitles blacklist"
    )
    delete_request_parser.add_argument(
        "provider", type=str, required=False, help="Provider name"
    )
    delete_request_parser.add_argument(
        "subs_id", type=str, required=False, help="Subtitles ID"
    )
