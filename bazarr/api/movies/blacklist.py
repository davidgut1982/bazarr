...
api_ns_movies_blacklist = Namespace(
    "Movies Blacklist",
...
class MoviesBlacklist(Resource):
    ...
    get_language_model = api_ns_movies_blacklist.model(
        "subtitles_language_model", subtitles_language_model
    )

    get_response_model = api_ns_movies_blacklist.model(
    ...
    post_request_parser.add_argument(
        "radarrid", type=int, required=True, help="Radarr ID"
    )
    post_request_parser.add_argument(
    ...
    @api_ns_movies_blacklist.response(
    ...
    delete_request_parser.add_argument(
        "all", type=str, required=False, help="Empty movies subtitles blacklist"
    )
    delete_request_parser.add_argument(
