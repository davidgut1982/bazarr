...
api_ns_subtitle_contents = Namespace(
    "Subtitle Contents", description="Retrieve contents of subtitle file"
)
...
class SubtitleNameContents(Resource):
    ...
    get_request_parser.add_argument(
        "subtitlePath", type=str, required=True, help="Subtitle filepath"
    )

    time_modal = api_ns_subtitle_contents.model(
        "time_modal",
        {
    ...
    get_response_model = api_ns_subtitle_contents.model(
        "SubtitlesContentsGetResponse",
        {
