...
api_ns_subtitles_info = Namespace(
    "Subtitles Info",
    description="Guess season number, episode number or language from "
...
class SubtitleNameInfo(Resource):
    ...
    get_response_model = api_ns_subtitles_info.model(
        "SubtitlesInfoGetResponse",
        {
