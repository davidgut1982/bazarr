...
class InvalidTokenError(PlexAuthError):
    def __init__(
        self,
        message="Invalid or malformed Plex authentication token. Please re-authenticate with Plex.",
    ):
...
class TokenExpiredError(PlexAuthError):
    def __init__(
        self,
        message="Plex authentication token has expired. Please re-authenticate with Plex to continue.",
    ):
...
class PlexConnectionError(PlexAuthError):
    def __init__(
        self,
        message="Unable to establish connection to Plex server. Please check server status and network connectivity.",
    ):
...
class PlexServerNotFoundError(PlexAuthError):
    def __init__(
        self,
        message="Plex server not found or not accessible. Please verify server URL and authentication credentials.",
    ):
...
class PlexPinExpiredError(PlexAuthError):
    def __init__(
        self,
        message="Plex authentication PIN has expired. Please request a new PIN and try again.",
    ):
...
class PlexAuthTimeoutError(PlexAuthError):
    def __init__(
        self,
        message="Plex authentication process timed out. Please try again or check your internet connection.",
    ):
...
class UnauthorizedError(PlexAuthError):
    def __init__(
        self,
        message="Access denied. Please check your Plex authentication credentials and permissions.",
    ):
