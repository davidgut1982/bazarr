...
api_ns_system_announcements = Namespace(
    "System Announcements", description="List announcements relative to Bazarr"
)
...
class SystemAnnouncements(Resource):
    ...
    post_request_parser.add_argument(
        "hash", type=str, required=True, help="hash of the announcement to dismiss"
    )
