...
api_ns_system_notifications = Namespace(
    "System Notifications", description="Send test notifications provider message"
)
...
class Notifications(Resource):
    ...
    patch_request_parser.add_argument(
        "url", type=str, required=True, help="Notifications provider URL"
    )
